...
const region = {
    en: {
        ...
        "sendingMessageTimeout": "Error: Due to repeated requests, you will be able to send messages after 30 seconds.",
    ...
    fa: {
        ...
        "sendingMessageTimeout": "خطا: به دلیل درخواست های مکرر، پس از 30 ثانیه قادر به ارسال پیام خواهید بود.",
